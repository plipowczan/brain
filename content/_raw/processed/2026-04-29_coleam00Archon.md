---
title: "coleam00/Archon: The first open-source harness builder for AI coding. Make AI coding deterministic and repeatable."
...
tags:
  - "clippings"
---
[![[31406bc4f930f54f8f7a5983322bda5c_MD5.png]]](https://github.com/coleam00/Archon/blob/dev/assets/logo.png)

## Archon

The first open-source harness builder for AI coding. Make AI coding deterministic and repeatable.

[![[0338afb7c2ac910d795d767faff93020_MD5.svg]]](https://trendshift.io/repositories/13964)
...
> ```
> 
> Or set `assistants.claude.claudeBinaryPath` in `~/.archon/config.yaml`. The Docker image ships Claude Code pre-installed. See [AI Assistants → Binary path configuration](https://archon.diy/docs/getting-started/ai-assistants/#binary-path-configuration-compiled-binaries-only) for details.
...
Please read [CONTRIBUTING.md](https://github.com/coleam00/Archon/blob/dev/CONTRIBUTING.md) before submitting a pull request.

## Star History

[![[6a1e94a86a63385d8c7202fdc752a88b_MD5.svg]]](https://www.star-history.com/?repos=coleam00%2FArchon&type=date&legend=top-left)

## License

[MIT](https://github.com/coleam00/Archon/blob/dev/LICENSE)