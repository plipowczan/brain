| --- | --- | --- | --- |
...
| [![[8fe36949e7be56f976cc5c2c06c4181c_MD5.png]]   **CodeRabbit**](https://www.coderabbit.ai/) | [![[091b21a26de5d72c6ffa0987b995201c_MD5.png]]   **Greptile**](https://www.greptile.com/go/ecc) | [![[9d4f72bde7718fae23c5ed629b11c26c_MD5.png]]   **Atlas Cloud**](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=ECC) |
| --- | --- | --- |
...
| [![[c5de9d1c9d6a98771054e8bc5eab3cf3_MD5.png]]   **The Shorthand Guide**](https://github.com/affaan-m/ECC/blob/main/the-shortform-guide.md)   <sub>Setup, foundations, philosophy. <b>Read this first.</b> (<a href="https://x.com/affaan/status/2012378465664745795">thread</a>)</sub> | [![[31f5f6b48f709afb24fb3044c5ca2777_MD5.png]]   **The Longform Guide**](https://github.com/affaan-m/ECC/blob/main/the-longform-guide.md)   <sub>Token optimization, memory persistence, evals, parallelization. (<a href="https://x.com/affaan/status/2014040193557471352">thread</a>)</sub> |
| --- | --- |
...
- **Antigravity**: Tightly integrated setup for workflows, skills, and flattened rules in `.agent/`. See [Antigravity Guide](https://github.com/affaan-m/ECC/blob/main/docs/ANTIGRAVITY-GUIDE.md).
- **JoyCode / CodeBuddy**: Project-local selective install adapters for commands, agents, skills, and flattened rules. See [JoyCode Adapter Guide](https://github.com/affaan-m/ECC/blob/main/docs/JOYCODE-GUIDE.md).
- **Qwen CLI**: Home-directory selective install adapter for commands, agents, skills, rules, and Qwen config. See [Qwen CLI Adapter Guide](https://github.com/affaan-m/ECC/blob/main/docs/QWEN-GUIDE.md).
- **Zed**: Project-local selective install adapter for `.zed/settings.json`, flattened rules, commands, agents, and skills.
- **Non-native harnesses**: Manual fallback path for Grok and similar interfaces. See [Manual Adaptation Guide](https://github.com/affaan-m/ECC/blob/main/docs/MANUAL-ADAPTATION-GUIDE.md).
- **Claude Code**: Native — this is the primary target.
**How do I contribute a new skill or agent?**

See [CONTRIBUTING.md](https://github.com/affaan-m/ECC/blob/main/CONTRIBUTING.md). The short version:
...
Please contribute! See [CONTRIBUTING.md](https://github.com/affaan-m/ECC/blob/main/CONTRIBUTING.md) for guidelines.
...
Hitting daily limits? See the **[Token Optimization Guide](https://github.com/affaan-m/ECC/blob/main/docs/token-optimization.md)** for recommended settings and workflow tips.
...
- **Deep dive.** See the [Security Guide](https://github.com/affaan-m/ECC/blob/main/the-security-guide.md).

---

## Sponsors

Featured sponsors are at the top of this README — full list and tiers in [SPONSORS.md](https://github.com/affaan-m/ECC/blob/main/SPONSORS.md). [Become a sponsor](https://github.com/sponsors/affaan-m).
