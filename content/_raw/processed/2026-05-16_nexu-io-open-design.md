---
title: "nexu-io/open-design: 🎨 Local-first, open-source alternative to Anthropic's Claude Design. ⚡ 19 Skills · ✨ 71 brand-grade Design Systems 🖼 Generate web · desktop · mobile prototypes · slides · images · videos · HyperFrames 📦 Sandboxed preview · HTML/PDF/PPTX/MP4 export 🤖 Runs on Claude Code / Codex / Cursor / Gemini / OpenCode / Qwen / Copilot / Hermes"
...
> **The open-source alternative to [Claude Design](https://x.com/claudeai/status/2045156267690213649).** Local-first, web-deployable, BYOK at every layer — **16 coding-agent CLIs** auto-detected on your `PATH` (Claude Code, Codex, Devin for Terminal, Cursor Agent, Gemini CLI, OpenCode, Qwen, Qoder CLI, GitHub Copilot CLI, Hermes, Kimi, Pi, Kiro, Kilo, Mistral Vibe, DeepSeek TUI) become the design engine, driven by **31 composable Skills** and **72 brand-grade Design Systems**. No CLI? An OpenAI-compatible BYOK proxy is the same loop minus the spawn.

[![Open Design — editorial cover: design with the agent on your laptop](https://github.com/nexu-io/open-design/raw/main/docs/assets/banner.png)](https://github.com/nexu-io/open-design/blob/main/docs/assets/banner.png)

**English** · [Español](https://github.com/nexu-io/open-design/blob/main/README.es.md) · [Português (Brasil)](https://github.com/nexu-io/open-design/blob/main/README.pt-BR.md) · [Deutsch](https://github.com/nexu-io/open-design/blob/main/README.de.md) · [Français](https://github.com/nexu-io/open-design/blob/main/README.fr.md) · [简体中文](https://github.com/nexu-io/open-design/blob/main/README.zh-CN.md) · [繁體中文](https://github.com/nexu-io/open-design/blob/main/README.zh-TW.md) · [한국어](https://github.com/nexu-io/open-design/blob/main/README.ko.md) · [日本語](https://github.com/nexu-io/open-design/blob/main/README.ja-JP.md) · [العربية](https://github.com/nexu-io/open-design/blob/main/README.ar.md) · [Русский](https://github.com/nexu-io/open-design/blob/main/README.ru.md) · [Українська](https://github.com/nexu-io/open-design/blob/main/README.uk.md) · [Türkçe](https://github.com/nexu-io/open-design/blob/main/README.tr.md)

---

## Why this exists

Anthropic's [Claude Design](https://x.com/claudeai/status/2045156267690213649) (released 2026-04-17, Opus 4.7) showed what happens when an LLM stops writing prose and starts shipping design artifacts. It went viral — and stayed closed-source, paid-only, cloud-only, locked to Anthropic's model and Anthropic's skills. There is no checkout, no self-host, no Vercel deploy, no swap-in-your-own-agent.
...
- [**`op7418/guizang-ppt-skill`**](https://github.com/op7418/guizang-ppt-skill) — the deck mode. Bundled verbatim under [`skills/guizang-ppt/`](https://github.com/nexu-io/open-design/blob/main/skills/guizang-ppt) with original LICENSE preserved; magazine-style layouts, WebGL hero, P0/P1/P2 checklists.
- [**`OpenCoworkAI/open-codesign`**](https://github.com/OpenCoworkAI/open-codesign) — the UX north star and our closest peer. The first open-source Claude-Design alternative. We borrow its streaming-artifact loop, its sandboxed-iframe preview pattern (vendored React 18 + Babel), its live agent panel (todos + tool calls + interruptible generation), and its five-format export list (HTML / PDF / PPTX / ZIP / Markdown). We deliberately diverge on form factor — they are a desktop Electron app bundling [`pi-ai`](https://github.com/badlogic/pi-mono/tree/main/packages/ai); we are a web app + local daemon that delegates to your existing CLI.
...
| **Design systems built-in** | **129** — 2 hand-authored starters + 70 product systems (Linear, Stripe, Vercel, Airbnb, Tesla, Notion, Anthropic, Apple, Cursor, Supabase, Figma, Xiaohongshu, …) from [`awesome-design-md`](https://github.com/VoltAgent/awesome-design-md), plus 57 design skills from [`awesome-design-skills`](https://github.com/bergside/awesome-design-skills) added directly under `design-systems/` |
...
| **Imports** | Drop a [Claude Design](https://x.com/claudeai/status/2045156267690213649) export ZIP onto the welcome dialog — `POST /api/import/claude-design` parses it into a real project so your agent can keep editing where Anthropic left off |
...
| [![01 · Entry view](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/01-entry-view.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/01-entry-view.png)   <sub><b>Entry view</b> — pick a skill, pick a design system, type the brief. The same surface for prototypes, decks, mobile apps, dashboards, and editorial pages.</sub> | [![02 · Turn-1 discovery form](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/02-question-form.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/02-question-form.png)   <sub><b>Turn-1 discovery form</b> — before the model writes a pixel, OD locks the brief: surface, audience, tone, brand context, scale. 30 seconds of radios beats 30 minutes of redirects.</sub> |
| --- | --- |
| [![03 · Direction picker](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/03-direction-picker.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/03-direction-picker.png)   <sub><b>Direction picker</b> — when the user has no brand, the agent emits a second form with 5 curated directions (Monocle / Modern Minimal / Tech Utility / Brutalist / Soft Warm). One radio click → a deterministic palette + font stack, no model freestyle.</sub> | [![04 · Live todo progress](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/04-todo-progress.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/04-todo-progress.png)   <sub><b>Live todo progress</b> — the agent's plan streams as a live card. <code>in_progress</code> → <code>completed</code> updates land in real time. The user can redirect cheaply, mid-flight.</sub> |
| [![05 · Sandboxed preview](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/05-preview-iframe.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/05-preview-iframe.png)   <sub><b>Sandboxed preview</b> — every <code>&lt;artifact&gt;</code> renders in a clean srcdoc iframe. Editable in place via the file workspace; downloadable as HTML, PDF, ZIP.</sub> | [![06 · 72-system library](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/06-design-systems-library.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/06-design-systems-library.png)   <sub><b>72-system library</b> — every product system shows its 4-color signature. Click for the full <code>DESIGN.md</code>, swatch grid, and live showcase.</sub> |
| [![07 · Magazine deck](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/07-magazine-deck.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/07-magazine-deck.png)   <sub><b>Deck mode (guizang-ppt)</b> — the bundled <a href="https://github.com/op7418/guizang-ppt-skill"><code>guizang-ppt-skill</code></a> drops in unchanged. Magazine layouts, WebGL hero backgrounds, single-file HTML output, PDF export.</sub> | [![08 · Mobile prototype](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/08-mobile-app.png)](https://github.com/nexu-io/open-design/blob/main/docs/screenshots/08-mobile-app.png)   <sub><b>Mobile prototype</b> — pixel-accurate iPhone 15 Pro chrome (Dynamic Island, status bar SVGs, home indicator). Multi-screen prototypes use the shared <code>/frames/</code> assets so the agent never re-draws a phone.</sub> |

## Skills

**31 skills ship in the box.** Each is a folder under [`skills/`](https://github.com/nexu-io/open-design/blob/main/skills) following the Claude Code [`SKILL.md`](https://docs.anthropic.com/en/docs/claude-code/skills) convention with an extended `od:` frontmatter that the daemon parses verbatim — `mode`, `platform`, `scenario`, `preview.type`, `design_system.requires`, `default_for`, `featured`, `fidelity`, `speaker_notes`, `animations`, `example_prompt` ([`apps/daemon/src/skills.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/skills.ts)).
...
| [![dating-web](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/dating-web.png)](https://github.com/nexu-io/open-design/blob/main/skills/dating-web)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/dating-web"><code>dating-web</code></a></b> · <i>prototype</i><br>Consumer dating / matchmaking dashboard — left rail nav, ticker bar, KPIs, 30-day mutual-matches chart, editorial typography.</sub> | [![digital-eguide](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/digital-eguide.png)](https://github.com/nexu-io/open-design/blob/main/skills/digital-eguide)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/digital-eguide"><code>digital-eguide</code></a></b> · <i>template</i><br>Two-spread digital e-guide — cover (title, author, TOC teaser) + lesson spread with pull-quote and step list. Creator / lifestyle tone.</sub> |
| --- | --- |
| [![email-marketing](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/email-marketing.png)](https://github.com/nexu-io/open-design/blob/main/skills/email-marketing)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/email-marketing"><code>email-marketing</code></a></b> · <i>prototype</i><br>Brand product-launch HTML email — masthead, hero image, headline lockup, CTA, specs grid. Centered single-column, table-fallback safe.</sub> | [![gamified-app](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/gamified-app.png)](https://github.com/nexu-io/open-design/blob/main/skills/gamified-app)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/gamified-app"><code>gamified-app</code></a></b> · <i>prototype</i><br>Three-frame gamified mobile-app prototype on a dark showcase stage — cover, today's quests with XP ribbons + level bar, quest detail.</sub> |
| [![mobile-onboarding](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/mobile-onboarding.png)](https://github.com/nexu-io/open-design/blob/main/skills/mobile-onboarding)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/mobile-onboarding"><code>mobile-onboarding</code></a></b> · <i>prototype</i><br>Three-frame mobile onboarding flow — splash, value-prop, sign-in. Status bar, swipe dots, primary CTA.</sub> | [![motion-frames](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/motion-frames.png)](https://github.com/nexu-io/open-design/blob/main/skills/motion-frames)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/motion-frames"><code>motion-frames</code></a></b> · <i>prototype</i><br>Single-frame motion-design hero with looping CSS animations — rotating type ring, animated globe, ticking timer. Hand-off ready for HyperFrames.</sub> |
| [![social-carousel](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/social-carousel.png)](https://github.com/nexu-io/open-design/blob/main/skills/social-carousel)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/social-carousel"><code>social-carousel</code></a></b> · <i>prototype</i><br>Three-card 1080×1080 social-media carousel — cinematic panels with display headlines that connect across the series, brand mark, loop affordance.</sub> | [![sprite-animation](https://github.com/nexu-io/open-design/raw/main/docs/screenshots/skills/sprite-animation.png)](https://github.com/nexu-io/open-design/blob/main/skills/sprite-animation)   <sub><b><a href="https://github.com/nexu-io/open-design/blob/main/skills/sprite-animation"><code>sprite-animation</code></a></b> · <i>prototype</i><br>Pixel / 8-bit animated explainer slide — full-bleed cream stage, animated pixel mascot, kinetic Japanese display type, looping CSS keyframes.</sub> |

### Design & marketing surfaces (prototype mode)

| Skill | Platform | Scenario | What it produces |
| --- | --- | --- | --- |
| [`web-prototype`](https://github.com/nexu-io/open-design/blob/main/skills/web-prototype) | desktop | design | Single-page HTML — landings, marketing, hero pages (default for prototype) |
| [`saas-landing`](https://github.com/nexu-io/open-design/blob/main/skills/saas-landing) | desktop | marketing | Hero / features / pricing / CTA marketing layout |
| [`dashboard`](https://github.com/nexu-io/open-design/blob/main/skills/dashboard) | desktop | operation | Admin / analytics with sidebar + dense data layout |
| [`pricing-page`](https://github.com/nexu-io/open-design/blob/main/skills/pricing-page) | desktop | sale | Standalone pricing + comparison tables |
| [`docs-page`](https://github.com/nexu-io/open-design/blob/main/skills/docs-page) | desktop | engineering | 3-column documentation layout |
| [`blog-post`](https://github.com/nexu-io/open-design/blob/main/skills/blog-post) | desktop | marketing | Editorial long-form |
| [`mobile-app`](https://github.com/nexu-io/open-design/blob/main/skills/mobile-app) | mobile | design | iPhone 15 Pro / Pixel framed app screen(s) |
| [`mobile-onboarding`](https://github.com/nexu-io/open-design/blob/main/skills/mobile-onboarding) | mobile | design | Multi-screen mobile onboarding flow (splash · value-prop · sign-in) |
| [`gamified-app`](https://github.com/nexu-io/open-design/blob/main/skills/gamified-app) | mobile | personal | Three-frame gamified mobile-app prototype |
| [`email-marketing`](https://github.com/nexu-io/open-design/blob/main/skills/email-marketing) | desktop | marketing | Brand product-launch HTML email (table-fallback safe) |
| [`social-carousel`](https://github.com/nexu-io/open-design/blob/main/skills/social-carousel) | desktop | marketing | 3-card 1080×1080 social carousel |
| [`magazine-poster`](https://github.com/nexu-io/open-design/blob/main/skills/magazine-poster) | desktop | marketing | Single-page magazine-style poster |
| [`motion-frames`](https://github.com/nexu-io/open-design/blob/main/skills/motion-frames) | desktop | marketing | Motion-design hero with looping CSS animations |
| [`sprite-animation`](https://github.com/nexu-io/open-design/blob/main/skills/sprite-animation) | desktop | marketing | Pixel / 8-bit animated explainer slide |
| [`dating-web`](https://github.com/nexu-io/open-design/blob/main/skills/dating-web) | desktop | personal | Consumer dating dashboard mockup |
| [`digital-eguide`](https://github.com/nexu-io/open-design/blob/main/skills/digital-eguide) | desktop | marketing | Two-spread digital e-guide (cover + lesson) |
| [`wireframe-sketch`](https://github.com/nexu-io/open-design/blob/main/skills/wireframe-sketch) | desktop | design | Hand-drawn ideation sketch — for the "show something visible early" pass |
| [`critique`](https://github.com/nexu-io/open-design/blob/main/skills/critique) | desktop | design | Five-dimensional self-critique scoresheet (Philosophy · Hierarchy · Detail · Function · Innovation) |
| [`tweaks`](https://github.com/nexu-io/open-design/blob/main/skills/tweaks) | desktop | design | AI-emitted tweaks panel — the model surfaces the parameters worth nudging |

### Deck surfaces (deck mode)

| Skill | Default for | What it produces |
| --- | --- | --- |
| [`guizang-ppt`](https://github.com/nexu-io/open-design/blob/main/skills/guizang-ppt) | **default** for deck | Magazine-style web PPT — bundled verbatim from [op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill), original LICENSE preserved |
| [`simple-deck`](https://github.com/nexu-io/open-design/blob/main/skills/simple-deck) | — | Minimal horizontal-swipe deck |
| [`replit-deck`](https://github.com/nexu-io/open-design/blob/main/skills/replit-deck) | — | Product-walkthrough deck (Replit-style) |
| [`weekly-update`](https://github.com/nexu-io/open-design/blob/main/skills/weekly-update) | — | Team weekly cadence as a swipe deck (progress · blockers · next) |

### Office & operations surfaces (prototype mode, document-flavored scenarios)

| Skill | Scenario | What it produces |
| --- | --- | --- |
| [`pm-spec`](https://github.com/nexu-io/open-design/blob/main/skills/pm-spec) | product | PM specification doc with TOC + decision log |
| [`team-okrs`](https://github.com/nexu-io/open-design/blob/main/skills/team-okrs) | product | OKR scoresheet |
| [`meeting-notes`](https://github.com/nexu-io/open-design/blob/main/skills/meeting-notes) | operation | Meeting decision log |
| [`kanban-board`](https://github.com/nexu-io/open-design/blob/main/skills/kanban-board) | operation | Board snapshot |
| [`eng-runbook`](https://github.com/nexu-io/open-design/blob/main/skills/eng-runbook) | engineering | Incident runbook |
| [`finance-report`](https://github.com/nexu-io/open-design/blob/main/skills/finance-report) | finance | Exec finance summary |
| [`invoice`](https://github.com/nexu-io/open-design/blob/main/skills/invoice) | finance | Single-page invoice |
| [`hr-onboarding`](https://github.com/nexu-io/open-design/blob/main/skills/hr-onboarding) | hr | Role onboarding plan |

Adding a skill takes one folder. Read [`docs/skills-protocol.md`](https://github.com/nexu-io/open-design/blob/main/docs/skills-protocol.md) for the extended frontmatter, fork an existing skill, restart the daemon, it appears in the picker. The catalog endpoint is `GET /api/skills`; per-skill seed assembly (template + side-file references) lives at `GET /api/skills/:id/example`.
...
Following Claude Code's [`SKILL.md` convention](https://docs.anthropic.com/en/docs/claude-code/skills), each skill is `SKILL.md` + `assets/` + `references/`. Drop a folder into [`skills/`](https://github.com/nexu-io/open-design/blob/main/skills), restart the daemon, it appears in the picker. The bundled `magazine-web-ppt` is [`op7418/guizang-ppt-skill`](https://github.com/op7418/guizang-ppt-skill) committed verbatim — original license preserved, attribution preserved.

### 3 · Design Systems are portable Markdown, not theme JSON.

The 9-section `DESIGN.md` schema from [`VoltAgent/awesome-design-md`](https://github.com/VoltAgent/awesome-design-md) — color, typography, spacing, layout, components, motion, voice, brand, anti-patterns. Every artifact reads from the active system. Switch system → next render uses the new tokens. The dropdown ships with **Linear, Stripe, Vercel, Airbnb, Tesla, Notion, Apple, Anthropic, Cursor, Supabase, Figma, Resend, Raycast, Lovable, Cohere, Mistral, ElevenLabs, X.AI, Spotify, Webflow, Sanity, PostHog, Sentry, MongoDB, ClickHouse, Cal, Replicate, Clay, Composio, Xiaohongshu…** — plus 57 design skills sourced from [`awesome-design-skills`](https://github.com/bergside/awesome-design-skills).
...
Every layer is composable. Every layer is a file you can edit. Read [`apps/daemon/src/prompts/system.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/prompts/system.ts) and [`apps/daemon/src/prompts/discovery.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/prompts/discovery.ts) to see the actual contract.
...
| Preview | Sandboxed iframe via `srcdoc` + per-skill `<artifact>` parser ([`apps/web/src/artifacts/parser.ts`](https://github.com/nexu-io/open-design/blob/main/apps/web/src/artifacts/parser.ts)) |
...
For advanced Docker configuration and environment variables, see [`QUICKSTART.md`](https://github.com/nexu-io/open-design/blob/main/QUICKSTART.md).
...
Windows users can follow [`docs/windows-troubleshooting.md`](https://github.com/nexu-io/open-design/blob/main/docs/windows-troubleshooting.md) for the native setup path and a tiny double-click launcher.

For desktop/background startup, fixed-port restarts, and media generation dispatcher checks (`OD_BIN`, `OD_DAEMON_URL`, `apps/daemon/dist/cli.js`), see [`QUICKSTART.md`](https://github.com/nexu-io/open-design/blob/main/QUICKSTART.md).
...
> **⚠️**
> 
> **Schema migrations are forward-only.** The daemon applies `CREATE TABLE IF NOT EXISTS` / `ALTER TABLE` changes on boot; there is no version guard. After migrating, **do not** open the same data dir with an older repo checkout — unsupported columns or behavior mismatches can leave the workspace inconsistent. Back up `app.sqlite*` before the first launch with the new app.

> **⚠️**
> 
> **Advanced: sharing one data dir between repo dev-server and Desktop app.** Pointing both at the same dir via `OD_DATA_DIR` is possible but **only safe one-at-a-time**. The daemon opens `app.sqlite` in WAL mode and writes uncoordinated files under `projects/` and `artifacts/`; running both writers concurrently can corrupt SQLite or clobber artifacts. Always stop the Desktop app before starting the dev-server, and stop the dev-server before opening the Desktop app:
> 
> ```
...
Full file map, scripts, and troubleshooting → [`QUICKSTART.md`](https://github.com/nexu-io/open-design/blob/main/QUICKSTART.md).
...
For fixed-port restarts, background startup, and full troubleshooting see [`QUICKSTART.md`](https://github.com/nexu-io/open-design/blob/main/QUICKSTART.md).

## Nix

A flake is published at the repo root. Home Manager is the recommended path for individual developers; a NixOS module is also exposed for shared/server installs. See [`nix/README.md`](https://github.com/nexu-io/open-design/blob/main/nix/README.md) for the full surface (data dir, secrets, `webFrontend` vs. bringing your own server, `OD_DAEMON_URL`).
...
[![The 72 design systems library — style guide spread](https://github.com/nexu-io/open-design/raw/main/docs/assets/design-systems-library.png)](https://github.com/nexu-io/open-design/blob/main/docs/assets/design-systems-library.png)

72 systems out of the box, each as a single [`DESIGN.md`](https://github.com/nexu-io/open-design/blob/main/design-systems/README.md):
...
The product-system library is imported via [`scripts/sync-design-systems.ts`](https://github.com/nexu-io/open-design/blob/main/scripts/sync-design-systems.ts) from [`VoltAgent/awesome-design-md`](https://github.com/VoltAgent/awesome-design-md). Re-run to refresh. The 57 design skills are sourced from [`bergside/awesome-design-skills`](https://github.com/bergside/awesome-design-skills) and added directly in `design-systems/`.
...
Full spec → [`apps/daemon/src/prompts/directions.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/prompts/directions.ts).

## Media generation

OD doesn't stop at code. The same chat surface that produces `<artifact>` HTML also drives **image**, **video**, and **audio** generation, with model adapters wired into the daemon's media pipeline ([`apps/daemon/src/media-models.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/media-models.ts), [`apps/web/src/media/models.ts`](https://github.com/nexu-io/open-design/blob/main/apps/web/src/media/models.ts)). Every render lands as a real file in the project workspace — `.png` for image, `.mp4` for video — and shows up as a download chip when the turn ends.
...
| [![3D Stone Staircase Evolution](https://camo.githubusercontent.com/de40e76a0d0a5f6f4b819a326d66ab0d4f70d7cd86e3a2fa321de1e41cd1d0c2/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737363636313936383430345f386135666c6d5f484751635f4b4f614d4141327674302e6a7067)](https://camo.githubusercontent.com/de40e76a0d0a5f6f4b819a326d66ab0d4f70d7cd86e3a2fa321de1e41cd1d0c2/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737363636313936383430345f386135666c6d5f484751635f4b4f614d4141327674302e6a7067)   <sub><b>3D Stone Staircase Evolution Infographic</b><br>3-step infographic, hewn-stone aesthetic</sub> | [![Illustrated City Food Map](https://camo.githubusercontent.com/6fa657a2d3ff5fe5a1b4b5cdb76991e7da052682209188e4a5b7dcb88bef8507/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737363636323637333031345f6e66307461775f4847524d4e447962734141474738382e6a7067)](https://camo.githubusercontent.com/6fa657a2d3ff5fe5a1b4b5cdb76991e7da052682209188e4a5b7dcb88bef8507/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737363636323637333031345f6e66307461775f4847524d4e447962734141474738382e6a7067)   <sub><b>Illustrated City Food Map</b><br>Editorial hand-illustrated travel poster</sub> | [![Cinematic Elevator Scene](https://camo.githubusercontent.com/b6f878fd0c45ebc3abbc2835309136eab2e0d500c36c69bdb86ccbce8dbf899e/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333134393032365f6764326b35305f4848435376796d626f4141567363632e6a7067)](https://camo.githubusercontent.com/b6f878fd0c45ebc3abbc2835309136eab2e0d500c36c69bdb86ccbce8dbf899e/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333134393032365f6764326b35305f4848435376796d626f4141567363632e6a7067)   <sub><b>Cinematic Elevator Scene</b><br>Single-frame editorial fashion still</sub> | [![Cyberpunk Anime Portrait](https://camo.githubusercontent.com/f0a2c32e49e2f38c4d2ee066b15027add5a7c45f8eda96dc1ba90c1082b76b20/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333136343939335f6d74356236395f4848446f57666561554145413656742e6a7067)](https://camo.githubusercontent.com/f0a2c32e49e2f38c4d2ee066b15027add5a7c45f8eda96dc1ba90c1082b76b20/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333136343939335f6d74356236395f4848446f57666561554145413656742e6a7067)   <sub><b>Cyberpunk Anime Portrait</b><br>Profile avatar — neon face text</sub> | [![Glamorous Woman in Black](https://camo.githubusercontent.com/0c8920ba286e3bf2402267a01a13923e6e84a2cebae1d46fdb2c875efa2b8ba1/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333138343235375f76623968766c5f48473974416b4f613441417552726e2e6a7067)](https://camo.githubusercontent.com/0c8920ba286e3bf2402267a01a13923e6e84a2cebae1d46fdb2c875efa2b8ba1/68747470733a2f2f636d732d6173736574732e796f756d696e642e636f6d2f6d656469612f313737373435333138343235375f76623968766c5f48473974416b4f613441417552726e2e6a7067)   <sub><b>Glamorous Woman in Black Portrait</b><br>Editorial studio portrait</sub> |
| --- | --- | --- | --- | --- |

Full set → [`prompt-templates/image/`](https://github.com/nexu-io/open-design/blob/main/prompt-templates/image). Sources: most pull from [`YouMind-OpenLab/awesome-gpt-image-prompts`](https://github.com/YouMind-OpenLab/awesome-gpt-image-prompts) (CC-BY-4.0) with author attribution preserved per template.

### Seedance 2.0 — video gallery (sample of 39)

| [![Music Podcast Guitar](https://camo.githubusercontent.)](https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/c4515f4f328539e1ded2cc32f4ce63e7/downloads/default.mp4)   <sub><b>Music Podcast &amp; Guitar Technique</b><br>4K cinematic studio film</sub> | [![Emotional Face](https://camo.githubusercontent.)](https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/4a47ba646e7cedd79363c861864b8714/downloads/default.mp4)   <sub><b>Emotional Face Close-up</b><br>Cinematic micro-expression study</sub> | [![Luxury Supercar](https://camo.githubusercontent.)](https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/7e8983364a95fe333f0f88bd1085a0e8/downloads/default.mp4)   <sub><b>Luxury Supercar Cinematic</b><br>Narrative product film</sub> | [![Forbidden City Cat](https://camo.githubusercontent.)](https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/0279a674ce138ab5a0a6f020a7273d89/downloads/default.mp4)   <sub><b>Forbidden City Cat Satire</b><br>Stylised satire short</sub> | [![Japanese Romance](https://camo.githubusercontent.)](https://github.com/YouMind-OpenLab/awesome-seedance-2-prompts/releases/download/videos/1402.mp4)   <sub><b>Japanese Romance Short Film</b><br>15s Seedance 2.0 narrative</sub> |
| --- | --- | --- | --- | --- |

Click any thumbnail to play the actual rendered MP4. Full set → [`prompt-templates/video/`](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video) (the `*-seedance-*` and Cinematic-tagged entries). Sources: [`YouMind-OpenLab/awesome-seedance-2-prompts`](https://github.com/YouMind-OpenLab/awesome-seedance-2-prompts) (CC-BY-4.0) with original tweet links and author handles preserved.
...
Eleven hyperframes prompts ship under [`prompt-templates/video/hyperframes-*.json`](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video), each one a concrete brief that produces a specific archetype:

| [![Product reveal](https://camo.githubusercontent.com/fe1d571773e4b15e1cbd70ce2e2c5cfeb0fa263a69987b398bac971548d9c69b/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6c6f676f2d6f7574726f2e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-product-reveal-minimal.json)   <sub><b>5s minimal product reveal</b> · 16:9 · push-in title card with shader transition</sub> | [![SaaS promo](https://camo.githubusercontent.com/f2c5d04db433ad932047df28524eb1f60df7618993aaa0b7cb9b983bd9c70acd/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6170702d73686f77636173652e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-saas-product-promo-30s.json)   <sub><b>30s SaaS product promo</b> · 16:9 · Linear/ClickUp-style with UI 3D reveals</sub> | [![TikTok karaoke](https://camo.githubusercontent.com/93aad44a79d01dda8529c4617382393b9b7b5f2b8293f090b6d0c8cd5b22e0e7/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f74696b746f6b2d666f6c6c6f772e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-tiktok-karaoke-talking-head.json)   <sub><b>TikTok karaoke talking-head</b> · 9:16 · TTS + word-synced captions</sub> | [![Brand sizzle](https://camo.githubusercontent.com/fe1d571773e4b15e1cbd70ce2e2c5cfeb0fa263a69987b398bac971548d9c69b/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6c6f676f2d6f7574726f2e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-brand-sizzle-reel.json)   <sub><b>30s brand sizzle reel</b> · 16:9 · beat-synced kinetic typography, audio-reactive</sub> |
| --- | --- | --- | --- |
| [![Data chart](https://camo.githubusercontent.com/d7da203e0ca7f0b7622415d6cb0ca5d6efa412e2357fa265a18930535f46288b/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f646174612d63686172742e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-data-bar-chart-race.json)   <sub><b>Animated bar-chart race</b> · 16:9 · NYT-style data infographic</sub> | [![Flight map](https://camo.githubusercontent.com/4d44d940fad71478f44cd985225f8e2db1f03d6c737eeb8ad2fe076e988078fb/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6e79632d70617269732d666c696768742e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-flight-map-route.json)   <sub><b>Flight map (origin → dest)</b> · 16:9 · Apple-style cinematic route reveal</sub> | [![Logo outro](https://camo.githubusercontent.com/fe1d571773e4b15e1cbd70ce2e2c5cfeb0fa263a69987b398bac971548d9c69b/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6c6f676f2d6f7574726f2e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-logo-outro-cinematic.json)   <sub><b>4s cinematic logo outro</b> · 16:9 · piece-by-piece assembly + bloom</sub> | [![Money counter](https://camo.githubusercontent.com/8ead3506fef8c686feb719d94063c58ec669e799117229239ce96c7a4bf70432/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6170706c652d6d6f6e65792d636f756e742e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-money-counter-hype.json)   <sub><b>$0 → $10K money counter</b> · 9:16 · Apple-style hype with green flash + burst</sub> |
| [![App showcase](https://camo.githubusercontent.com/f2c5d04db433ad932047df28524eb1f60df7618993aaa0b7cb9b983bd9c70acd/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f6170702d73686f77636173652e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-app-showcase-three-phones.json)   <sub><b>3-phone app showcase</b> · 16:9 · floating phones with feature callouts</sub> | [![Social overlay](https://camo.githubusercontent.com/0d12d94c829897cc96d253ceb41dfdfdb4dac4fcaa2215afd8f0abeb4bd9a112/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f696e7374616772616d2d666f6c6c6f772e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-social-overlay-stack.json)   <sub><b>Social overlay stack</b> · 9:16 · X · Reddit · Spotify · Instagram in sequence</sub> | [![Website to video](https://camo.githubusercontent.com/0d12d94c829897cc96d253ceb41dfdfdb4dac4fcaa2215afd8f0abeb4bd9a112/68747470733a2f2f7374617469632e68657967656e2e61692f68797065726672616d65732d6f73732f646f63732f696d616765732f636174616c6f672f626c6f636b732f696e7374616772616d2d666f6c6c6f772e706e67)](https://github.com/nexu-io/open-design/blob/main/prompt-templates/video/hyperframes-website-to-video-promo.json)   <sub><b>Website-to-video pipeline</b> · 16:9 · captures site at 3 viewports + transitions</sub> |  |
...
| Axis | [Claude Design](https://x.com/claudeai/status/2045156267690213649) (Anthropic) | [Open CoDesign](https://github.com/OpenCoworkAI/open-codesign) | **Open Design** |
| --- | --- | --- | --- |
| License | Closed | MIT | **Apache-2.0** |
| Form factor | Web (claude.ai) | Desktop (Electron) | **Web app + local daemon** |
| Deployable on Vercel | ❌ | ❌ | **✅** |
| Agent runtime | Bundled (Opus 4.7) | Bundled ([`pi-ai`](https://github.com/badlogic/pi-mono/tree/main/packages/ai)) | **Delegated to user's existing CLI** |
| Skills | Proprietary | 12 custom TS modules + `SKILL.md` | **31 file-based [`SKILL.md`](https://docs.anthropic.com/en/docs/claude-code/skills) bundles, droppable** |
| Design system | Proprietary | `DESIGN.md` (v0.2 roadmap) | **`DESIGN.md` × 129 systems shipped** |
| Provider flexibility | Anthropic only | 7+ via [`pi-ai`](https://github.com/badlogic/pi-mono/tree/main/packages/ai) | **16 CLI adapters + OpenAI-compatible BYOK proxy** |
...
Adding a new CLI is one entry in [`apps/daemon/src/agents.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/agents.ts). Streaming format is one of `claude-stream-json`, `qoder-stream-json`, `copilot-stream-json`, `json-event-stream` (with a per-CLI `eventParser`), `acp-json-rpc`, `pi-rpc`, or `plain`.
...
| Project | Role here |
| --- | --- |
| [`Claude Design`](https://x.com/claudeai/status/2045156267690213649) | The closed-source product this repo is the open-source alternative to. |
...
| [**`op7418/guizang-ppt-skill`**](https://github.com/op7418/guizang-ppt-skill) | Magazine-web-PPT skill bundled verbatim under [`skills/guizang-ppt/`](https://github.com/nexu-io/open-design/blob/main/skills/guizang-ppt) with original LICENSE preserved. Default for deck mode. P0/P1/P2 checklist culture borrowed for every other skill. |
...
| [**`OpenCoworkAI/open-codesign`**](https://github.com/OpenCoworkAI/open-codesign) | The first open-source Claude-Design alternative and our closest peer. UX patterns adopted: streaming-artifact loop, sandboxed-iframe preview (vendored React 18 + Babel), live agent panel (todos + tool calls + interruptible), five-format export list (HTML/PDF/PPTX/ZIP/Markdown), local-first storage hub, `SKILL.md` taste-injection, and the first pass of comment-mode preview annotations. UX patterns still on our roadmap: full surgical-edit reliability and AI-emitted tweaks panel. **We deliberately do not vendor [`pi-ai`](https://github.com/badlogic/pi-mono/tree/main/packages/ai)** — open-codesign bundles it as the agent runtime; we delegate to whichever CLI the user already has. |
| [`VoltAgent/awesome-claude-design`](https://github.com/VoltAgent/awesome-claude-design) / [`awesome-design-md`](https://github.com/VoltAgent/awesome-design-md) | Source of the 9-section `DESIGN.md` schema and 70 product systems imported via [`scripts/sync-design-systems.ts`](https://github.com/nexu-io/open-design/blob/main/scripts/sync-design-systems.ts). |
| [`bergside/awesome-design-skills`](https://github.com/bergside/awesome-design-skills) | Source of 57 design skills added directly as normalized `DESIGN.md` files under `design-systems/`. |
...
| [Claude Code skills](https://docs.anthropic.com/en/docs/claude-code/skills) | The `SKILL.md` convention adopted verbatim — any Claude Code skill drops into `skills/` and is picked up by the daemon. |

Long-form provenance write-up — what we take from each, what we deliberately don't — lives at [`docs/references.md`](https://github.com/nexu-io/open-design/blob/main/docs/references.md).
...
- Skill marketplace (`od skills install <github-repo>`) and `od skill add | list | remove | test` CLI surface (drafted in [`docs/skills-protocol.md`](https://github.com/nexu-io/open-design/blob/main/docs/skills-protocol.md), implementation pending)
- Packaged Electron build out of `apps/packaged/` — macOS (Apple Silicon) and Windows (x64) downloads on [open-design.ai](https://open-design.ai/) and the [GitHub releases page](https://github.com/nexu-io/open-design/releases)

Phased delivery → [`docs/roadmap.md`](https://github.com/nexu-io/open-design/blob/main/docs/roadmap.md).
...
[![Star Open Design on GitHub — github.com/nexu-io/open-design](https://github.com/nexu-io/open-design/raw/main/docs/assets/star-us.png)](https://github.com/nexu-io/open-design)
...
- **Add a skill** — drop a folder into [`skills/`](https://github.com/nexu-io/open-design/blob/main/skills) following the [`SKILL.md`](https://docs.anthropic.com/en/docs/claude-code/skills) convention.
- **Add a design system** — drop a `DESIGN.md` into [`design-systems/<brand>/`](https://github.com/nexu-io/open-design/blob/main/design-systems) using the 9-section schema.
- **Wire up a new coding-agent CLI** — one entry in [`apps/daemon/src/agents.ts`](https://github.com/nexu-io/open-design/blob/main/apps/daemon/src/agents.ts).

Full walkthrough, bar-for-merging, code style, and what we don't accept → [`CONTRIBUTING.md`](https://github.com/nexu-io/open-design/blob/main/CONTRIBUTING.md) ([Deutsch](https://github.com/nexu-io/open-design/blob/main/CONTRIBUTING.de.md), [Français](https://github.com/nexu-io/open-design/blob/main/CONTRIBUTING.fr.md), [简体中文](https://github.com/nexu-io/open-design/blob/main/CONTRIBUTING.zh-CN.md)).
...
[![Open Design contributors](https://camo.githubusercontent.com/44d310e83b1c2be0873d81e715301ed74d6e9f5a25fc817511bdcafab79499d5/68747470733a2f2f636f6e747269622e726f636b732f696d6167653f7265706f3d6e6578752d696f2f6f70656e2d64657369676e2663616368655f627573743d323032362d30352d3136)](https://github.com/nexu-io/open-design/graphs/contributors)
...
![Open Design — repository metrics](https://github.com/nexu-io/open-design/raw/main/docs/assets/github-metrics.svg)

The SVG above is regenerated daily by [`.github/workflows/metrics.yml`](https://github.com/nexu-io/open-design/blob/main/.github/workflows/metrics.yml) using [`lowlighter/metrics`](https://github.com/lowlighter/metrics). Trigger a manual refresh from the **Actions** tab if you want it sooner; for richer plugins (traffic, follow-up time), add a `METRICS_TOKEN` repository secret with a fine-grained PAT.

## Star History

[

![Open Design star history](https://camo.githubusercontent.com/097095cfd1d1fd47add3fcae32cbd10ef12fa245d30a97a1466b0a95e569c814/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d6e6578752d696f2f6f70656e2d64657369676e26747970653d446174652663616368655f627573743d323032362d30352d3136)

](https://star-history.com/#nexu-io/open-design&Date)

If the curve bends up, that's the signal we look for. ★ this repo to push it.

## Credits

The HTML PPT Studio family of skills — the master [`skills/html-ppt/`](https://github.com/nexu-io/open-design/blob/main/skills/html-ppt) and the per-template wrappers under [`skills/html-ppt-*/`](https://github.com/nexu-io/open-design/blob/main/skills) (15 full-deck templates, 36 themes, 31 single-page layouts, 27 CSS animations + 20 canvas FX, the keyboard runtime, and the magnetic-card presenter mode) — are integrated from the open-source project [`lewislulu/html-ppt-skill`](https://github.com/lewislulu/html-ppt-skill) (MIT). The upstream LICENSE ships in-tree at [`skills/html-ppt/LICENSE`](https://github.com/nexu-io/open-design/blob/main/skills/html-ppt/LICENSE) and authorship credit goes to [@lewislulu](https://github.com/lewislulu). Each per-template Examples card (`html-ppt-pitch-deck`, `html-ppt-tech-sharing`, `html-ppt-presenter-mode`, `html-ppt-xhs-post`, …) delegates authoring guidance to the master skill so the upstream's prompt → output behavior is preserved end-to-end when you click **Use this prompt**.

The magazine / horizontal-swipe deck flow under [`skills/guizang-ppt/`](https://github.com/nexu-io/open-design/blob/main/skills/guizang-ppt) is integrated from [`op7418/guizang-ppt-skill`](https://github.com/op7418/guizang-ppt-skill) (MIT). Authorship credit goes to [@op7418](https://github.com/op7418).

## License

Apache-2.0. The bundled `skills/guizang-ppt/` retains its original [LICENSE](https://github.com/nexu-io/open-design/blob/main/skills/guizang-ppt/LICENSE) (MIT) and authorship attribution to [op7418](https://github.com/op7418). The bundled `skills/html-ppt/` retains its original [LICENSE](https://github.com/nexu-io/open-design/blob/main/skills/html-ppt/LICENSE) (MIT) and authorship attribution to [lewislulu](https://github.com/lewislulu).