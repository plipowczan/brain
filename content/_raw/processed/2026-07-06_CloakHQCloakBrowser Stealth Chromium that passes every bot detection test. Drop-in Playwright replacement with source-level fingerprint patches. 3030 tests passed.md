---
title: "CloakHQ/CloakBrowser: Stealth Chromium that passes every bot detection test. Drop-in Playwright replacement with source-level fingerprint patches. 30/30 tests passed."
source: "https://github.com/CloakHQ/CloakBrowser"
author:
published:
created: 2026-07-04
description: "Stealth Chromium that passes every bot detection test. Drop-in Playwright replacement with source-level fingerprint patches. 30/30 tests passed. - CloakHQ/CloakBrowser"
tags:
  - "clippings"
---
[![[9577f46c387195012eb997e404501e9f_MD5.png]]](https://camo.githubusercontent.com/43781a18d7166adfa1b725bbc84c37994876f34d5bf6d429e92fd35ddb11444f/68747470733a2f2f692e696d6775722e636f6d2f63716b703666472e706e67)
...
[![[fe8e60ecbd9723b96f30b41fac2664f4_MD5.gif]]](https://camo.githubusercontent.com/e62e994d725c2bb03c55e3ccc1cdd4f9fc15df681764d7547d5d909c535bf389/68747470733a2f2f692e696d6775722e636f6d2f497642304974372e676966)
...
> Community-maintained.NET client built on Microsoft.Playwright. See [`dotnet/README.md`](https://github.com/CloakHQ/CloakBrowser/blob/main/dotnet/README.md) for the full API.
...
See the full [CHANGELOG.md](https://github.com/CloakHQ/CloakBrowser/blob/main/CHANGELOG.md) for details.
...
[![[3fc0cd916cf72db2ee0e0349fb4f655d_MD5.png]]](https://camo.githubusercontent.com/feded3374c1c5ed60ddf62fa0f69588539c77d1395918682716fffc46b181354/68747470733a2f2f692e696d6775722e636f6d2f68764951794d762e706e67)  
*Pro/latest build: reCAPTCHA v3 score 0.9 — server-side verified (human-level)*

[![[5d1e11d78b2af393e3326ab6437dbbec_MD5.png]]](https://camo.githubusercontent.com/63c5bf6299894c50429329210d34d1d570d124b2bf1be567e9b53e50293826cb/68747470733a2f2f692e696d6775722e636f6d2f714d49526668712e706e67)  
*Cloudflare Turnstile non-interactive challenge — auto-resolved*

[![[20cd5466cccefc8944418de6ec86e167_MD5.png]]](https://camo.githubusercontent.com/b0021eb94d49a0844538b66d4ac8d0f5b6d9402225160b689d474473a6418555/68747470733a2f2f692e696d6775722e636f6d2f505273773672542e706e67)  
*BrowserScan bot detection — NORMAL (4/4 checks passed)*

[![[7630c19b3b43824740b1db92723c3d84_MD5.png]]](https://camo.githubusercontent.com/e5ae2119c02c77cea372a199e10694620ad50a7b0d1e0b4fa9d4a2632f9ff3c3/68747470733a2f2f692e696d6775722e636f6d2f396e32433774752e706e67)  
*Pro/latest build: FingerprintJS web-scraping demo — data served, not blocked*

[![[057dc118b70ad3d3869592b36077b1da_MD5.png]]](https://camo.githubusercontent.com/9dd7d951c691cae639bb7ce70e618d8642354c7d3c2e2b8fd770ec7e0688195f/68747470733a2f2f692e696d6775722e636f6d2f7372436346744b2e706e67)  
...
**Python** — see [`examples/`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples):

- [`basic.py`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/basic.py) — Launch and load a page
- [`persistent_context.py`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/persistent_context.py) — Persistent profile with cookie/localStorage persistence
- [`recaptcha_score.py`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/recaptcha_score.py) — Check your reCAPTCHA v3 score
- [`stealth_test.py`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/stealth_test.py) — Run against 6 detection sites
- [`fingerprint_scan_test.py`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/fingerprint_scan_test.py) — Test against fingerprint-scan.com and CreepJS

**JavaScript** — see [`js/examples/`](https://github.com/CloakHQ/CloakBrowser/blob/main/js/examples):

- [`basic-playwright.ts`](https://github.com/CloakHQ/CloakBrowser/blob/main/js/examples/basic-playwright.ts) — Playwright launch and load
- [`basic-puppeteer.ts`](https://github.com/CloakHQ/CloakBrowser/blob/main/js/examples/basic-puppeteer.ts) — Puppeteer launch and load
- [`stealth-test.ts`](https://github.com/CloakHQ/CloakBrowser/blob/main/js/examples/stealth-test.ts) — Run against 6 detection sites
...
| Platform | Example |
| --- | --- |
| [AWS Lambda](https://aws.amazon.com/lambda/) | [`aws_lambda/`](https://github.com/CloakHQ/CloakBrowser/blob/main/examples/integrations/aws_lambda) — One-shot scrapes in Lambda (container image) |

## Platforms

| Platform | Free | Pro | Status |
| --- | --- | --- | --- |
| Linux x86\_64 | Chromium 146 (58 patches) | Chromium 148 (59 patches) | ✅ |
...
| macOS x86\_64 (Intel) | Chromium 145 (26 patches) | Chromium 148 (59 patches) | ✅ |
| Windows x86\_64 | Chromium 146 (58 patches) | Chromium 148 (59 patches) | ✅ |
...
**Building from source** — a [`Dockerfile`](https://github.com/CloakHQ/CloakBrowser/blob/main/Dockerfile) is also included if you prefer to build your own image:
...
- 📋 **Changelog** — [CHANGELOG.md](https://github.com/CloakHQ/CloakBrowser/blob/main/CHANGELOG.md)
...
- 📧 **Contact** — [cloakhq@pm.me](mailto:cloakhq@pm.me)
...
![[6bbe9d05c07f6b4eba6c0f1419ca5cf2_MD5.svg]]

](https://www.star-history.com/?repos=CloakHQ%2FCloakBrowser&type=date&legend=top-left)