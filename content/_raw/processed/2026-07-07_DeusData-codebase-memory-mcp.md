...
See [docs/cbmignore.md](https://github.com/DeusData/codebase-memory-mcp/blob/main/docs/cbmignore.md) for the full `.cbmignore` how-to: syntax, precedence across the ignore layers, and negation semantics.
...
Need the full config-file reference? See [docs/CONFIGURATION.md](https://github.com/DeusData/codebase-memory-mcp/blob/main/docs/CONFIGURATION.md).
