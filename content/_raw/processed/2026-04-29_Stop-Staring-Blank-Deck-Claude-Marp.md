...
source: "https://www.freecodecamp.org/news/how-to-use-claude-code-and-marp-to-think-through-presentations/#heading-1-install-marp-cli"
author:
  - "[[Omer Rosenbaum]]"
published: 2026-03-19
created: 2026-04-29
description: "The hard part of building a presentation is figuring out the story. What are you trying to say? What’s the structure? Which sections build on which? Where does the data go, table or bullets? Before th"
tags:
  - "clippings"
---
...
(I used a deck to think through this post. You can find it [here](https://omerr.github.io/claude-skills/presentations/claude-code-marp/).)
...
![[3a3f2d04ebe8bd7cb0fdf3fc118caa9c_MD5.png]]
```
...
![[7635c353838685bbc4bf78ddf8675fea_MD5.png]]
...
```
![[f1cc4046d99f26c00ca7e9b590ec8d0c_MD5.png]]
```
...
![[1fef2a88d7bbc64410d703a2351bcb5c_MD5.png]]
...
```
![[01f6dd80cbe1d5cffca6b459f0dc0429_MD5.png]]
...
This works with Claude Code, Cursor, GitHub Copilot, and other AI agents. You can also install manually  ( see the [repo](https://github.com/Omerr/claude-skills) for details).
...
[**Marp**](https://marp.app/) (Markdown Presentation Ecosystem) converts `.md` files into slides. Your deck starts with frontmatter:
...
Instead, I created a **Claude Code skill** (see it [here](https://github.com/Omerr/claude-skills.git)), a reusable set of instructions that Claude follows whenever you invoke it. It has two parts:
...
![[c0a37bcbcf5669fb32e3a291ea807199_MD5.png]]
...
![[c9854380777a59bf7cb83b9c0afbdffa_MD5.png]]
...
If you want to try it: `npm install -g @marp-team/marp-cli`, run `npx skills add Omerr/claude-skills`, and then `/create-marp-deck`. You'll have a deck in minutes and a workflow you can reuse for every presentation after that.

### About the Author

[Omer Rosenbaum](https://www.linkedin.com/in/omer-rosenbaum-034a08b9/) is the author of the [Brief](https://youtube.com/@BriefVid) [YouTube Channel](https://youtube.com/@BriefVid). He’s also a cyber training expert and founder of Checkpoint Security Academy. He’s the author of [Product-Led Research](https://www.freecodecamp.org/news/product-led-research-a-practical-guide-for-randd-leaders-full-book/), [Gitting Things Done](https://www.freecodecamp.org/news/gitting-things-done-book/) (in English) and [Computer Networks](https://data.cyber.org.il/networks/networks.pdf) (in Hebrew). You can find him on [Twitter](https://twitter.com/Omer_Ros).