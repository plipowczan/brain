---
title: "chaseai-yt/claudex-loop: Claude Code skill: four-phase plan hardening (recon, interrogate, Codex adversarial review, cross-model build & inspection) — two AI models harden your plan before a line of code exists, then swap jobs to build it. Whoever built it never grades it."
source: "https://github.com/chaseai-yt/claudex-loop"
author:
published:
created: 2026-09-06
description: "Claude Code skill: four-phase plan hardening (recon, interrogate, Codex adversarial review, cross-model build & inspection) — two AI models harden your plan before a line of code exists, then swap jobs to build it. Whoever built it never grades it. - chaseai-yt/claudex-loop"
tags:
  - "clippings"
---
[![[5296cb50ef19080387463142fd87dae6_MD5.svg]]](https://github.com/chaseai-yt/claudex-loop/blob/main/assets/logo.svg)
...
[![[74e0115e677db91875460d47541cbc67_MD5.svg]]](https://github.com/chaseai-yt/claudex-loop/blob/main/assets/run.svg)
...
> **Coming from grill-me-codex or crucible?** This repo *was* both — GitHub redirects the old URLs, so `git pull` in your existing clone just works. The old grill skills live on in [`legacy/`](https://github.com/chaseai-yt/claudex-loop/blob/main/legacy) (copy them only if you want them; `/claudex-loop` doesn't need them).
...
- The [`legacy/`](https://github.com/chaseai-yt/claudex-loop/blob/main/legacy) skills' Act 1 (`grill-me`, `grill-with-docs`) © [Matt Pocock](https://github.com/mattpocock/skills) (MIT) — see their `THIRD-PARTY-NOTICES.md`. Claudex-loop's interview is an original redesign.
...
*MIT — see [LICENSE](https://github.com/chaseai-yt/claudex-loop/blob/main/LICENSE)*