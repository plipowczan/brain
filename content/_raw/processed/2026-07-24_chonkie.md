---
title: "feyninc/chonkie: 🦛 CHONK docs with Chonkie ✨ — The lightweight ingestion library for fast, efficient and robust RAG pipelines"
source: "https://github.com/feyninc/chonkie"
author:
published:
created: 2026-07-23
description: "🦛 CHONK docs with Chonkie ✨ — The lightweight ingestion library for fast, efficient and robust RAG pipelines - feyninc/chonkie"
tags:
  - "clippings"
---
...
**🔌 32+ [integrations](#integrations)**: Works with your favorite tools and vector DBs out of the box!  
**💬 ️Multilingual**: Out-of-the-box support for 56 languages  
**☁️ Cloud-Friendly**: CHONK locally or in the [Cloud](https://labs.chonkie.ai/)  
...
Chonkie follows the rule of minimum installs. Have a favorite chunker? Read our [docs](https://docs.chonkie.ai/) to install only what you need. Don't want to think about it? Simply install `all` (Not recommended for production environments).
...
Check out our detailed [benchmarks](https://github.com/feyninc/chonkie/blob/main/BENCHMARKS.md) to see how Chonkie races past the competition! 🏃♂️💨

## 🤝 Contributing

Want to help grow Chonkie? Check out [CONTRIBUTING.md](https://github.com/feyninc/chonkie/blob/main/CONTRIBUTING.md) to get started! Whether you're fixing bugs, adding features, or improving docs, every contribution helps make Chonkie a better CHONK for everyone.
...
@software{chonkie2025,
   = {Minhas, Bhavnick AND Nigam, Shreyash},
