...
tags:
  - "clippings"
---
[![[df2a697e58bfd2f965b79d331fd9db9a_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/datalab-logo.png)
...
[![[8358997274fb325985e221a9dc53355f_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/olmocr_bench.png)
...
[![[afdb097aebf8b8ee90a5fa26d061c146_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/olmocr_digital.png)
...
[![[bfe4f9d88b7f4e2c105263f50fd7ec50_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/olmocr_scores_bar.png) [![[1e74c67d992dd193d182635e6943e4ca_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/olmocr_throughput_bar.png)
...
[![[6fe219805c7454f8fff71444c3af50ba_MD5.png]]](https://github.com/datalab-to/marker/blob/master/data/images/marker_throughput.png)
...
`fast, no OCR` is pure CPU (pdftext + a 20M layout model, no VLM) and is CPU-bound — it needs no GPU at all. `fast` and `balanced` are GPU-assisted and still leave the GPU with headroom on a single B200 (balanced saturates only ~30% of it — the ceiling is the VLM's decode throughput, so throughput scales further with more/larger inference-server replicas). Measure it on your own hardware with `benchmarks/inference.py` (see [benchmarks/README.md](https://github.com/datalab-to/marker/blob/master/benchmarks/README.md)); it reports sustained pages/sec at your chosen concurrency.
...
Everything above — the olmocr-bench scores and the throughput numbers, for both marker and the competitors — is reproducible with the harness in [`benchmarks/`](https://github.com/datalab-to/marker/blob/master/benchmarks). In short:
...
Competitor runners (liteparse, docling, MinerU), each using the tool's native parallelism, live in `benchmarks/competitors/`. See [benchmarks/README.md](https://github.com/datalab-to/marker/blob/master/benchmarks/README.md) for the full step-by-step.
