...
- it has built in documents like in [[Notion]]
- it has great collaboration features
- it is free for great majority of most important (for me) features

## 🧩 Current Use
Aktualnie ClickUp to moje centralne narzędzie do zarządzania pracą:
- **Daily/weekly task execution** — sprint tracking, planowanie tygodnia, daily standup notes
- **CRM** — tracking leadów, pipeline sprzedażowy, follow-upy
- **Project tracking** — osobne spaces dla [[Qamera AI]] (200IQ Labs) i [[PLSoft]] (consulting)
- **Dokumentacja** — meeting notes, decyzje, kontekst projektów
