...
I knew most of the stuff mentioned in the book. The pomodoro technique doesn't work for me for some reason. I just lack of motivation to turn it on and keep working on the topic I decided to. I have a problem in focusing on one task ta a time - I know that pomodoro technique helps with that but I simply don't follow the rules - I sabotage myself. I also failed to do breaks between pomodoro sessions - I kept working because for me it is not intuitive that I have to stop in the middle of something.
For me the most interesting technique which seems to work is the self explanation with my own words - it helps me find the holes in my understanding. If I can explain with confidence I also understand the topic.
The "Hard start" technique is also very powerful in my opinion since I experienced many times that for the problem I tried to solve and stuck often the solution came to my mind later when I stopped working on it or another day after a good night sleep.
# 📒 Summary + Notes
...
![Image of working memory vs long-term memory](https://encrypted-tbn0.gstatic.com/licensed-image?q=tbn:ANd9GcQ4hVjEtASJbnNnB3i7dwbwsHEHegXcqoZ75BrASpxKBYTdKq7rI0ovuyQcnSD3ixeqliFPj1kKAgJRrfske_heGo2NfUnc6q73xtcc5T5UzJ0eCts)

Shutterstock
- **Chunking:** Breaking down large amounts of information into smaller, manageable pieces (e.g., learning a monologue line by line).
...
- **Key principle:** You must _actively solve_ the problems yourself, not just _read_ the answers. Solving builds procedural memory, while just reading only burdens your working memory.
...
- **4-Step Model for Self-Regulated Learning:**
    1. **Understand the task:** Know exactly what the goal is.
    2. **Set goals and make a plan:** Create a specific plan (e.g., "learn 50 words a day for 3 weeks").
    3. **Apply strategies:** Start learning, testing different techniques.
    4. **Monitor and adapt:** Regularly check your progress and change methods if they aren't working.
