...
| AI/KNOWLEDGE/INFO | 19 | knowledge-note(18), compiled-note(1) | knowledge, info, ai, agents, context-engineering, self-improving, prompts, paradigm, tts, voice |
...
| CODE/KNOWLEDGE/INFO | 3 | knowledge-note(2), compiled-note(1) | knowledge, info, ai, chatbots, rag, prd, specs, methodology, sdd |
...
## Recent Changes
- 2026-06-04 CODE/KNOWLEDGE/INFO/PRD Methodologies and Templates.md (ingested — deep-research report; 15 PRD methodologies/templates, classic PM frameworks vs 2026 spec-driven development across 18 fields)
- 2026-06-04 AI/KNOWLEDGE/INFO/TTS Engines Comparison (Polish).md (ingested — deep-research report; 19 TTS engines for Polish quality/cost, Azure MOS 4.04 wins quality, Polly wins price, all Elo English-only)
...
- 2026-05-28 AI/TOOLS/Impeccable.md (ingested — pbakaus/impeccable design-language skill: 1 skill, 23 commands, 27 anti-pattern rules + anti-slop CLI, extends Anthropic frontend-design, Apache 2.0)
- 2026-05-28 AI/KNOWLEDGE/INFO/Software 3.0.md (ingested — Karpathy's Software 1.0/2.0/3.0 thesis as business playbook; sell outcomes; four moats: data, prompting, system design, trust)
- 2026-05-27 AI/TOOLS/CocoIndex.md (ingested — incremental indexing engine for AI agents, Python + Rust, Apache 2.0)
- 2026-05-27 AI/TOOLS/Claude SEO.md (ingested — AgriciDaniel/claude-seo, 25 sub-skills + 18 agents Claude Code SEO/GEO plugin, MIT)
- 2026-05-26 BUSINESS/KNOWLEDGE/INFO/Richard van der Blom.md (ingested — LinkedIn algorithm researcher profile, Algorithm Insights Report, Just Connecting, TRIBE, Narify, Scripe ecosystem)
- 2026-05-24 _outputs/answers/2026-05-24_claude-md-guidelines.md (Q&A — wytyczne do przygotowania CLAUDE.md, synteza z Context/Harness Engineering, Karpathy Skills, Best Practice)
- 2026-05-22 AI/KNOWLEDGE/INFO/Self-Improving Company.md (ingested — YC Root Access talk by Jared Friedman on recursive AI loops, legible context, burn-tokens-not-headcount)
- 2026-05-22 AI/TOOLS/Karpathy Skills.md (merged — added multica-ai mirror + author X handle to Resources)
- 2026-05-21 _outputs/answers/2026-05-21_claude-code-video.md (Q&A — Claude Code for video processing)
- 2026-05-19 BUSINESS/KNOWLEDGE/INFO/Lean Canvas.md (ingested — Ash Maurya's one-page business model, PL source translated)
- 2026-05-19 AI/TOOLS/Voicebox.md (ingested — local-first OSS voice studio with MCP)
- 2026-05-19 AI/TOOLS/Video Use.md (ingested — browser-use/video-use, transcript-driven editing for Claude Code)
- 2026-05-19 AI/TOOLS/Personal AI Infrastructure.md (ingested — danielmiessler PAI v5 Life OS)
- 2026-05-19 AI/TOOLS/HyperFrames.md (ingested — HeyGen HTML→video, Apache 2.0)
- 2026-05-19 AI/TOOLS/DESIGN MD Spec.md (ingested — google-labs-code design.md format spec)
- 2026-05-19 AI/TOOLS/Browser Use.md (ingested — Python framework + cloud agent for browser automation)
- 2026-05-19 AI/TOOLS/Browser Harness.md (ingested — thin self-healing CDP harness)
- 2026-05-19 AI/KNOWLEDGE/INFO/40 AI Prompts for Expert Output.md (ingested — engineered cross-model prompt library)
