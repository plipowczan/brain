...
Pack a user-selected set of vault notes (by wikilink list, tag, or folder) into a portable brain-pack zip with a manifest, without modifying the vault. TBD: expand.
