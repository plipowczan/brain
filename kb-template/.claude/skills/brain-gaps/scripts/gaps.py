...
weakly-connected notes (total degree <= 1). The `brain-gaps` skill layers semantic
...
def main(argv=None):
    ...
    try:
        ...
        print(f"gaps: no graph index at {args.graph}; run /b:reindex first", file=sys.stderr)
        return 2
